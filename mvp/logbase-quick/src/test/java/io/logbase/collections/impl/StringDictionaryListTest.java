 ...
 */
public class StringDictionaryListTest implements BatchListFactory {
  ...
  public void testList(){
    StringListTestSuite<String> tester = new StringListTestSuite(this, testData);
    tester.testList();
  }

  @Override
  public BatchList<String> newInstance() {
    return new StringDictionaryList();
  }
}
