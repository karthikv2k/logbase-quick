 ...
 */
public class GreaterThanEquals implements FunctionPredicate {
  ...
  public GreaterThanEquals(int value, PredicateType predicateType) {
  ...
  public GreaterThanEquals(float value, PredicateType predicateType) {
  ...
  public GreaterThanEquals(double value, PredicateType predicateType) {
  ...
  public GreaterThanEquals(long value, PredicateType predicateType) {
